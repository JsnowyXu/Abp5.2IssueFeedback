...
namespace Fun2RepairMVC.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(Fun2RepairMVCDbContext context, int tenantId, AbpFunctionManager functionManager)
        {
            _context = context;
            _tenantId = tenantId;
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new Fun2RepairMVCAuthorizationProvider(_functionManager))
